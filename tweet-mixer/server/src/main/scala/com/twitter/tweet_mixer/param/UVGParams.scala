...
object UVGParams {
  ...
  object MinCoOccurrenceParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_min_co_occurrence",
        default = 3,
        min = 0,
        max = 500
      )
  ...
  object TweetBasedMinScoreParam
      extends FSBoundedParam[Double](
        name = "user_video_graph_tweet_based_min_score",
        default = 0.5,
        min = 0.0,
        max = 10.0
      )
  object TweetBasedDegreeExponentParam
      extends FSBoundedParam[Double](
        name = "user_video_graph_tweet_based_degree_exponent",
        default = 0.5,
        min = 0.1,
        max = 1.0
      )
  object ConsumersBasedMinScoreParam
      extends FSBoundedParam[Double](
        name = "user_video_graph_consumers_based_min_score",
        default = 4.0,
        min = 0.0,
        max = 10.0
      )
  ...
  object MaxConsumerSeedsNumParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_max_user_seeds_num",
        default = 100,
        min = 0,
        max = 300
      )
  ...
  object CoverageExpansionOldTweetEnabledParam
      extends FSParam[Boolean](
        name = "user_video_graph_coverage_expansion_old_tweet_enabled",
        default = false
      )

  object SimilarityAlgorithm
      extends FSEnumParam[SimilarityAlgorithmEnum.type](
        name = "user_video_graph_similarity_algorithm_id",
        default = SimilarityAlgorithmEnum.LogCosine,
        enum = SimilarityAlgorithmEnum
      )

  object EnableUVGCacheParam
      extends FSParam[Boolean](
        name = "user_video_graph_enable_cache",
        default = true
      )

  /**
   * Sets the number of users to sample from the input video, this increases fanout significantly
   */
  object MaxNumSamplesPerNeighborParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_max_num_samples_per_neighbor",
        default = 100,
        min = 100,
        max = 100000
      )
  ...
  /**
   * Filters out spammy users we sample for related queries, i.e. don't sample users that watch over K videos
   */
  object MaxLeftNodeDegreeParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_max_left_node_degree",
        default = 100,
        min = 0,
        max = 100000
      )
  ...
  /**
   * Filters out videos with too many views, may pollute related results
   */
  object MaxRightNodeDegreeParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_max_right_node_degree",
        default = 0, // 0 maps to no limit in UVG
        min = 0,
        max = Int.MaxValue
      )

  object SampleRHSTweetsParam
      extends FSParam[Boolean](
        name = "user_video_graph_sample_rhs_tweets",
        default = false
      )

  object EnableTweetEmbeddingBasedFilteringParam
      extends FSParam[Boolean](
        name = "user_video_graph_enable_tweet_embedding_based_filtering",
        default = false
      )

  object OutlierFilterPercentileThresholdParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_outlier_filter_percentile_threshold",
        default = 80,
        min = 0,
        max = 100
      )
  ...
  object OutlierMinRequiredSignalsParam
      extends FSBoundedParam[Int](
        name = "user_video_graph_outlier_min_required_signals",
        default = 10,
        min = 0,
        max = 100
      )
  ...
  val boundedIntFSOverrides =
    Seq(
      ...
      MaxNumSamplesPerNeighborParam,
      MaxLeftNodeDegreeParam,
      MaxRightNodeDegreeParam,
