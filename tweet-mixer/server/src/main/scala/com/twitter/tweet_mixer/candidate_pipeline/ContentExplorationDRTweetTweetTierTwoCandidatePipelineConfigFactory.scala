...
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRTweetTweetTierTwoEnabled
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRTweetTweetTierTwoMaxCandidates
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRTweetTweetTierTwoScoreThreshold
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRTweetTweetTierTwoVectorDBCollectionName
...
@Singleton
class ContentExplorationDRTweetTweetTierTwoCandidatePipelineConfigFactory @Inject() (
  ...
  ): ContentExplorationDRTweetTweetTierTwoCandidatePipelineConfig[Query] = {
    val candidateSource = deepRetrievalTweetTweetEmbeddingANNCandidateSourceFactory.build(
      CandidatePipelineConstants.ContentExplorationDRTweetTweetTierTwo
    )
...
class ContentExplorationDRTweetTweetTierTwoCandidatePipelineConfig[Query <: PipelineQuery](
  ...
  override val gates: Seq[Gate[PipelineQuery]] = Seq(
    ParamGate(
      name = "ContentExplorationDeepRetrievalTweetTweetSimilarityTier2",
      param = ContentExplorationDRTweetTweetTierTwoEnabled
    ),
  ...
  override val queryTransformer: CandidatePipelineQueryTransformer[
    ...
    val collectionName =
      query.params(ContentExplorationDRTweetTweetTierTwoVectorDBCollectionName)
    val maxCandidates =
      query.params(ContentExplorationDRTweetTweetTierTwoMaxCandidates)
    val scoreThreshold =
      query.params(ContentExplorationDRTweetTweetTierTwoScoreThreshold)
