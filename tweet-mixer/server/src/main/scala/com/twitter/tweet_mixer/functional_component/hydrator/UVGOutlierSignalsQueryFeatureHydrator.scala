...
import com.twitter.tweet_mixer.param.UVGParams.OutlierFilterPercentileThresholdParam
import com.twitter.tweet_mixer.param.UVGParams.OutlierMinRequiredSignalsParam

import javax.inject.Inject

object UVGOutlierSignalsFeature extends FeatureWithDefaultOnFailure[PipelineQuery, Set[Long]] {
  override def defaultValue: Set[Long] = Set.empty
}

class UVGOutlierSignalsQueryFeatureHydrator @Inject() (stats: StatsReceiver)
    extends QueryFeatureHydrator[PipelineQuery] {

  private val statsScope: StatsReceiver = stats.scope("uvg_outlier_signal_counter")
  ...
  override val identifier: FeatureHydratorIdentifier =
    FeatureHydratorIdentifier("UVGOutlierSignals")

  override def features: Set[Feature[_, _]] = Set(UVGOutlierSignalsFeature)
  ...
  override def hydrate(query: PipelineQuery): Stitch[FeatureMap] = {
    ...
    Stitch.value(
      FeatureMap(UVGOutlierSignalsFeature, outliers)
    )
  }
}
