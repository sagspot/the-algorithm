...
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRUserTweetTierTwoEnabled
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRUserTweetVectorDBCollectionName
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationDRUserTweetTierTwoMaxCandidates
...
@Singleton
class ContentExplorationDRUserTweetTierTwoCandidatePipelineConfig @Inject() (
  ...
  override val gates: Seq[Gate[PipelineQuery]] = Seq(
    ParamGate(
      name = "ContentExplorationDeepRetrievalUserTweetSimilarityTierTwo",
      param = ContentExplorationDRUserTweetTierTwoEnabled
    )
  )
  ...
  override val queryTransformer: CandidatePipelineQueryTransformer[
    ...
    val defaultKey = DRANNKey(
      ...
      maxCandidates = query.params(ContentExplorationDRUserTweetTierTwoMaxCandidates),
      tier = Some("tier2")
    )
  ...
  override def candidateSource: CandidateSource[
    ...
    CandidatePipelineConstants.ContentExplorationDRUserTweetTierTwo)
