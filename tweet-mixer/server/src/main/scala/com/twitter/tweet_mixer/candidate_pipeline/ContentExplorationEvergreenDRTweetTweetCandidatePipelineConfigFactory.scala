...
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationEvergreenDRTweetTweetEnabled
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationEvergreenDRTweetTweetMaxCandidates
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationEvergreenDRTweetTweetScoreThreshold
import com.twitter.tweet_mixer.param.TweetMixerGlobalParams.ContentExplorationEvergreenDRTweetTweetVectorDBCollectionName
...
@Singleton
class ContentExplorationEvergreenDRTweetTweetCandidatePipelineConfigFactory @Inject() (
  ...
  ): ContentExplorationEvergreenDRTweetTweetCandidatePipelineConfig[Query] = {
    val candidateSource = deepRetrievalTweetTweetEmbeddingANNCandidateSourceFactory.build(
      CandidatePipelineConstants.ContentExplorationEvergreenDRTweetTweet
    )
    new ContentExplorationEvergreenDRTweetTweetCandidatePipelineConfig(
      candidateSource,
      signalFn,
...
class ContentExplorationEvergreenDRTweetTweetCandidatePipelineConfig[Query <: PipelineQuery](
  ...
  override val identifier: CandidatePipelineIdentifier = CandidatePipelineIdentifier(
    identifierPrefix + CandidatePipelineConstants.ContentExplorationEvergreenDRTweetTweet)

  override val gates: Seq[Gate[PipelineQuery]] = Seq(
    ParamGate(
      name = "ContentExplorationEvergreenDeepRetrievalTweetTweetSimilarity",
      param = ContentExplorationEvergreenDRTweetTweetEnabled
    ),
  ...
  override val queryTransformer: CandidatePipelineQueryTransformer[
    ...
    val collectionName =
      query.params(ContentExplorationEvergreenDRTweetTweetVectorDBCollectionName)
    val maxCandidates =
      query.params(ContentExplorationEvergreenDRTweetTweetMaxCandidates)
    val scoreThreshold =
      query.params(ContentExplorationEvergreenDRTweetTweetScoreThreshold)
